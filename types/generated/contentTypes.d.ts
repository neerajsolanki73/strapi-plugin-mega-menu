...
export interface ApiMegaMenuMegaMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    megaMenu: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<'plugin::mega-menu.mega-menu-builder'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginMegaMenuMenuItem extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'plugin::mega-menu.menu-item': PluginMegaMenuMenuItem;
